...
class BC_Admin {
    ...
    public function enqueue_styles() {
        ...
        wp_enqueue_style('bc_materialize_icons','https://fonts.googleapis.com/icon?family=Material+Icons', array(), $this->version, 'all' );
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script('bc_materialize_admin_js', BC_PLUGIN_DIR_URL . 'helpers/materialize/js/materialize.min.js', ['jquery'], $this->version, true );
